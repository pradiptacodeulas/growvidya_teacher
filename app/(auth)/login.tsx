...
export default function LoginScreen() {
  ...
  const handleSessionSuccess = (resData: any, defaultMessage: string) => {
    ...
    const userData: any = {
      ...
      school_id: String(rawTeacher?.schoolId || rawTeacher?.school_id || ""),
      school_name: rawTeacher?.schoolName || rawTeacher?.school_name || "",
      ...
      gender: rawTeacher?.gender !== undefined ? rawTeacher.gender : null,
      gender_name: rawTeacher?.gender_name || (rawTeacher?.gender === 2 ? "Female" : rawTeacher?.gender === 1 ? "Male" : ""),
