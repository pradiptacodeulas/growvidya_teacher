...
function CustomDrawerContent(props: any) {
  ...
  const isSectionActive = (sectionKey: string) => {
    ...
    switch (sectionKey) {
      ...
      case 'exam':
        return ['/examination/schedule', '/examination/attendance', '/examination/results', '/examination/add-marks', '/examination/add-attendance'].includes(cleanCurrent);
      case 'payroll':
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <Drawer.Screen name="examination/add-attendance" options={{ drawerItemStyle: { display: 'none' } }} />
